...
int main(void) {
    ...
    // --- 7-seg outputs: PA5–PA9, PB10 (ตัด PC7 ออก) --- //
    ...
    GPIOC->MODER |=  (0b01 << GPIO_MODER_MODER7_Pos);  // PC7 output
    ...
    while (1) {
        ...
        // --- Buzzer ON when light intensity HIGH --- //
        if (lightintensity > 500.0f)   // threshold ปรับค่าได้
            GPIOC->ODR |= (1 << 7);    // PC7 = High → Buzzer ON
        else
            GPIOC->ODR &= ~(1 << 7);   // PC7 = Low  → Buzzer OFF
        ...
        // --- Display number --- //
        switch (number) {
            case 1: GPIOA->ODR |= (1 << 8); break;
            case 2: GPIOA->ODR |= (1 << 9); break;
            case 3: GPIOA->ODR |= (1 << 8); GPIOA->ODR |= (1 << 9); break;
            case 4: GPIOB->ODR |= (1 << 10); break;
            case 5: GPIOB->ODR |= (1 << 10); GPIOA->ODR |= (1 << 8); break;
            case 6: GPIOB->ODR |= (1 << 10); GPIOA->ODR |= (1 << 9); break;
            case 7: GPIOA->ODR |= (1 << 8); GPIOA->ODR |= (1 << 9); GPIOB->ODR |= (1 << 10); break;
            case 8: GPIOA->ODR |= (1 << 8); GPIOA->ODR |= (1 << 9); GPIOB->ODR |= (1 << 10); break;
            case 9: GPIOA->ODR |= (1 << 9); GPIOB->ODR |= (1 << 10); break;
